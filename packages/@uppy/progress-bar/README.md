...
ProgressBar is a minimalist plugin that shows the current upload progress in a thin bar element. Like the ones used by
YouTube and GitHub when navigating between pages.
