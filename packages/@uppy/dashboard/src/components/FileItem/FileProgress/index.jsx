      ...
      <div className="uppy-Dashboard-Item-progress">
        <div className="uppy-Dashboard-Item-progressIndicator">
          <ProgressCircleContainer>
            ...
            <polygon className="uppy-Dashboard-Item-progressIcon--check" transform="translate(2, 3)"
  ...
  if (props.error && !props.hideRetryButton) {
    return (
      ...
      <ProgressIndicatorButton {...props}>
        <svg aria-hidden="true" focusable="false" className="uppy-c-icon uppy-Dashboard-Item-progressIcon--retry"
             width="28" height="31" viewBox="0 0 16 19">
    ...
    return (
      ...
      <ProgressIndicatorButton {...props}>
        <ProgressCircleContainer>
          ...
          {
            props.file.isPaused
              ? <polygon className="uppy-Dashboard-Item-progressIcon--play" transform="translate(3, 3)"
  ...
  if (!props.resumableUploads && props.individualCancellation && !props.hideCancelButton) {
    return (
      ...
      <ProgressIndicatorButton {...props}>
        <ProgressCircleContainer>
          <ProgressCircle progress={props.file.progress.percentage}/>
          <polygon className="cancel" transform="translate(2, 2)"
